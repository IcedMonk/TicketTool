...
function TicketComments() {
  ...
  return (
    <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl bg-gray-100 h-full">
            ...
            {ticketById?.comments.map((comment) => (
              <div
                ...
                className={`col-start-1 ${
                  comment.user_name === userAuth.name
                    ? "col-end-8"
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`relative ${
                      comment.user_name === userAuth.name ? "ml-3" : "mr-3"
                    } text-sm ${
                      comment.user_name === userAuth.name
                        ? "bg-white"
                        : "bg-indigo-100"
                  ...
                  >
                    ...
                    {comment.attachments.length > 0 && (
                      <button className="bg-indigo-300 p-1 top-0 right-0 rounded-full">
                        Download
                      </button>
                    )}
                  </div>
      ...
      <div className="sticky bottom-0 flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
        <div>
