...
function DashboardStats() {
  return (
    <div>
      <h3 className="text-base font-semibold leading-6 text-gray-900 mt-4 pl-1">
        All the tickets
      </h3>

      <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-6 pt-4 shadow sm:px-3 sm:pt-3">
          <dt>
          ...
          <dd class="ml-16 flex items-baseline pb-6">
            ...
            <div class="absolute inset-x-0 bottom-0 bg-gray-50 px-4 py-2 sm:px-6">
              <div class="text-sm">
                <a
                  href="#"
        ...
        <div class="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-6 pt-4 sm:pb- shadow sm:px-3 sm:pt-3">
          <dt>
