  ...
  return (
    <div>
      ...
      <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        <div className="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-6 pt-4 shadow sm:px-3 sm:pt-3">
          <dt>
        ...
        <div className="relative overflow-hidden rounded-lg bg-gray-600 px-4 pb-6 pt-4 sm:pb- shadow sm:px-3 sm:pt-3">
          <dt>
